...
public class Decimal16Test {
    ...
    {
        Decimal16 d1 = new Decimal16("1.0024");
        Decimal16 d2 = new Decimal16("1.0024000000000000");

        assert d1.compareTo(d2)==0;

        d1 = new Decimal16("1.024");
        d2 = new Decimal16("1.0024000000000000");
        assert d1.compareTo(d2) > 0;
    }
    ...
    public void testDouble(String d)
    {
        ...
        Decimal16 d1 = new Decimal16(d);
        Decimal16 d2 = new Decimal16(d);
